public class practical4Q3 {
    public static void main(String[] args) {
        ...
        double courseworkMark = ((double)studentDetails.getTotalScore() /100 * 20);

        System.out.printf("Student ID: %s\nName: %s\nNumber of Quizzes: %d\nTotal Quiz Score: %d\nAverage Quiz Score: %.2f\nCoursework mark: %.2f\n\n",
                studentDetails.getStudentID(), studentDetails.getName(), studentDetails.getNumberOfQuizzes(),
                studentDetails.getTotalScore(), studentDetails.getAverageQuizScore(), courseworkMark);
        System.out.printf("Student ID: %s\nName: %s\nNumber of Quizzes: %d\nTotal Quiz Score: %d\nAverage Quiz Score: %.2f\nCoursework mark: %.2f\n\n",
                studentDetails2.getStudentID(), studentDetails2.getName(), studentDetails2.getNumberOfQuizzes(),
                studentDetails2.getTotalScore(), studentDetails2.getAverageQuizScore(), courseworkMark);
    }
}
